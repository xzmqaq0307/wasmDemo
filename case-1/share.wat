(module $share.wasm
  ...
  (func $emscripten::internal::InitFunc::InitFunc_void__*____ (type 7) (param i32 i32) (result i32)
    ...
    local.get 5
    return)
  (func $set_test_int_ (type 2) (param i32)
    ...
    return)
  (func $get_test__ (type 0) (result i32)
    (local i32 i32)
    i32.const 0
    local.set 0
    local.get 0
    ...
    local.get 1
    return)
  (func $set_obj_MyObject_ (type 2) (param i32)
    ...
    local.get 2
    local.get 1
    i64.store offset=66280 align=4
    i32.const 66280
    local.set 3
    i32.const 8
    local.set 4
    ...
    i32.store
    return)
  (func $get_obj__ (type 2) (param i32)
    (local i32 i64 i32 i32 i32 i32 i32)
    i32.const 0
    local.set 1
    local.get 1
    i64.load offset=66280 align=4
    local.set 2
    local.get 0
    local.get 2
    i64.store align=4
  ...
  (func $print_obj__ (type 3)
    ...
    call $print_int_
    return)
  (func $reset_obj__ (type 3)
    (local i32)
    i32.const 66280
    local.set 0
    local.get 0
    call $MyObject::resetAll__
    return)
  ...
  (func $emscripten::internal::ArgArrayGetter<emscripten::internal::TypeList<void__emscripten::internal::AllowedRawPointer<MyObject>>>::get__ (type 0) (result i32)
    ...
    local.get 0
    return)
  (func $_GLOBAL__sub_I_share.cpp (type 3)
            ...
            block  ;; label = @5
                ...
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    block  ;; label = @9
                      block  ;; label = @10
                        i32.const 0
                        i32.load offset=66932
                        i32.eqz
                        br_if 0 (;@10;)
                        i32.const 0
                        i32.load offset=66940
                        local.set 4
                        br 1 (;@9;)
                      end
                      i32.const 0
                      i64.const -1
                      i64.store offset=66944 align=4
                      i32.const 0
                      i64.const 17592186048512
                      i64.store offset=66936 align=4
                      i32.const 0
                      local.get 1
                      i32.const 12
                      i32.add
                      ...
                      i32.xor
                      i32.store offset=66932
                      i32.const 0
                      i32.const 0
                      i32.store offset=66952
                      i32.const 0
                      i32.const 0
              ...
              block  ;; label = @6
                block  ;; label = @7
                  ...
                  i32.add
                  i32.const 0
                  i64.load offset=66916 align=4
                  i64.store align=4
                  local.get 8
                  i32.const 0
                  i64.load offset=66908 align=4
                  i64.store offset=8 align=4
                  i32.const 0
                  local.get 8
                  i32.const 8
                  i32.add
                  i32.store offset=66916
                  i32.const 0
                  local.get 2
                  i32.store offset=66912
                  i32.const 0
  ...
  (export "set_test" (func $set_test_int_))
  (export "get_test" (func $get_test__))
  (export "set_obj" (func $set_obj_MyObject_))
  (export "get_obj" (func $get_obj__))
  (export "print_obj" (func $print_obj__))
  (export "reset_obj" (func $reset_obj__))
  ...
  (data $.data (i32.const 66280) "\05\00\00\00\05\00\00\00\05\00\00\00\b0\05\01\00\05\00\00\00\00\00\00\00\00\00\00\00\08\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\09\00\00\00\0a\00\00\00\94\05\01\00\00\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\ff\ff\ff\ff\ff\ff\ff\ff\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\f8\02\01\00"))
